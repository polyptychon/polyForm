...
module.exports =
  ...
  .directive("formControl", require("./directives/FormControl"))
  .directive("formGroup", require("./directives/FormGroup"))
  .directive("inputGroup", require("./directives/InputGroup"))
  .directive("inputGroupAddon", require("./directives/InputGroupAddon"))
  .directive("errorMessage", require("./directives/ErrorMessage"))
  .directive("validIcon", require("./directives/ValidIcon"))
  ...
  .directive("uiSelect2Query", ['$timeout', '$http', require("./directives/UiSelect2Query")])
